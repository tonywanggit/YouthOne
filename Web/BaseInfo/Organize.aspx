<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="Organize.aspx.cs" Inherits="BaseInfo_Organize" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phContent" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <br />
        <dxwtl:ASPxTreeList ID="treeList" runat="server" AutoGenerateColumns="False" Width="100%" DataSourceID="OdsOrganize" 
            ...
            SettingsText-ConfirmDelete="您确认要删除此行?" SettingsText-CommandDelete="删除" SettingsText-CommandEdit="编辑" SettingsText-RecursiveDeleteError="该节点下有支部，无法删除该节点！" SettingsEditing-AllowNodeDragDrop="True">
             <settingstext commandcancel="取消" commanddelete="删除" commandedit="编辑" commandnew="新增" commandupdate="保存" confirmdelete="您确认要删除此行?" recursivedeleteerror="该节点下有组织，无法删除该节点！" />
             <border borderstyle="Solid"></border>
             <Settings GridLines="Both" />
             <SettingsBehavior ExpandCollapseAction="NodeDblClick" />
             <SettingsEditing Mode="EditFormAndDisplayNode" />
            <Columns>
                <dxwtl:TreeListTextColumn FieldName="OG_NAME" Caption="组织名称">
                    <EditFormSettings VisibleIndex="0" />
                    <PropertiesTextEdit ValidationSettings-RequiredField-IsRequired="true" ValidationSettings-RequiredField-ErrorText="组织名称必须填写！" />
    ...
    <asp:ObjectDataSource ID="OdsOrganize" runat="server" 
        ...
        <InsertParameters>
            <asp:Parameter Name="OG_NAME" Type="String" />
